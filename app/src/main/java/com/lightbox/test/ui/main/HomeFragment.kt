...
class HomeFragment : Fragment() {
    ...
    private fun setUpButtons() {
        addButton(0.3F, getString(R.string.title_1), getString(R.string.subtitle_1))
        addButton(0.4F, getString(R.string.title_2), getString(R.string.subtitle_2))
        addButton(0.3F, getString(R.string.title_3), getString(R.string.subtitle_3))
        addButton(0.4F, getString(R.string.title_4), getString(R.string.subtitle_4))
        addButton(0.3F, getString(R.string.title_5), getString(R.string.subtitle_5))
    }

    fun addButton(width: Float, title: String, subTitle: String) {
